    ...
    <Wrapper>
      <LeftSide>
        <Content>
          ...
          <HeroText>Behold the miracle of the Atomic Harvest!</HeroText>
      ...
      <Center>
        ...
        <Card id='molecules'>
          <ProductTitle>
            <div>
              Molecules<ProductPrice>€39.999</ProductPrice>
            </div>
      ...
      <PageCountMobile>2 / 4</PageCountMobile>
      <ScrollIconDesktop>
        <CgScrollV />
      </ScrollIconDesktop>
      <PageCountDesktop>2 / 4</PageCountDesktop>
